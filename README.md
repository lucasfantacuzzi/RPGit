...
**RPGit** is a **self-hosted Git server** with an **RPG** layer, turning software development into an epic adventure.
...
Ideas, discussions, and pull requests are welcome — open an issue if you’d like to join the quest.
